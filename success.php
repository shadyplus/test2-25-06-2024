...
<button style="margin-bottom:15px;font-size:20px;padding:15px;background-color: #fff5d4;" type="button" id="subscribe" onclick="subscribe('dz')">
                        ...
                        <span class="subscribe__submit-text">مراقبة التسليم</span>

</button>
</center>
            <div class="subscribe" id="block">
                <div class="subscribe__cta">احصل على خصم دائم بنسبة 50٪ على عملية الشراء التالية!</div>
                <form id="subscribe__form" class="subscribe__input" action="/subscribe" method="post">
                    <input type="email" name="email" placeholder="أدخل بريدك الإلكتروني" autocomplete="email"
                        required>
                    <button type="submit" id="next">
                        <span class="subscribe__submit-text">للاشتراك</span>
